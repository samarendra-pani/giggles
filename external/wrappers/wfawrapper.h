...
class WFAWrapper {
    ...
    public:
         ...
         */
        int align(const char* query, int query_len, const char* allele, int allele_len, uint8_t type);
    ...
    private:
         ...
         */
        int attempt_alignment(const char* query, int query_len, const char* allele, int allele_len, uint8_t type);
