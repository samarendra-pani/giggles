/**
 * Original implementation at https://github.com/eblerjana/pangenie/blob/master/src/samplingtransitions.hpp (Commit f682fb6)
 */

#ifndef SAMPLING_TRANSITIONS_H
#define SAMPLING_TRANSITIONS_H
